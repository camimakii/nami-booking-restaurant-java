...
//    private static final String RESTAU_NAME = "MY_RESTAU_NAME";
    ...
    public void updateRestaurant() throws Exception {
        ...
        assertTrue(restaurantCreated.getName().equals(newName));
        assertTrue(restaurantRepository.findById(restaurantCreated.getId()).get().getName().equals(newName));
    }
